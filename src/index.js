...
const deprecated = (cb, cb2, cb3) => {
  console.error('redux-persist-legacy: this method of importing storages has been removed. instead use `import { asyncLocalStorage } from "redux-persist/storages"`')
